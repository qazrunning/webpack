        ...
        var e = function() {
            ...
            window.GetSelectWndInfo = function(e) {
                if (Z()) {
                    ...
                    var t, n = v.loadXML(e);
                    if (0 < re.$XML(n).find("SelectWnd", !0).length) P = parseInt(re.$XML(n).find("SelectWnd").eq(0).text(), 10),
                    null === g && R(),
                    (t = []).push("<RealPlayInfo>"),
            ...
            q = function() {
                ...
                n = 0; n < t; n++) navigator.mimeTypes[n].type.toLowerCase() == p.szMimeTypes && (e = "<embed align='center' type='" + p.szMimeTypes + "' width='" + h + "' height='" + f + "' name='" + c + "' wndtype='" + p.iWndowType + "' playmode='" + p.iPlayMode + "' colors='" + p.szColorProperty + "'>");
                return e
            },
            R = function() {
                if (!Z() && null !== y) {
            ...
            w = function(s) {
                ...
                o.I_GetAnalogChannelInfo(s.szIP, {
                    success: function(e) {
                        s.iAnalogChannelNum = re.$XML(e).find("VideoInputChannel", !0).length
                    }
                }),
            ...
            W = function(e) {
                var t = null;
                if (k(e))(t = X(e)).iRtspPort,
                t.iDevicePort;
                else {
                    for (var n = H(e), r = !1, s = 0; s < n.length; s++) if (n[s].ipv4 == e.szIP || n[s].ipv6 == e.szIP) {
                        r = !0;
                        break
                    }
            ...
            X = function(e) {
                ...
                return e.oProtocolInc.getPortInfo(e, {
                    ...
                    success: function(e) {
                        ...
                        s = 554;
                        for (var n = 0,
                        r = t.length; n < r; n++)"rtsp" === re.$XML(t).eq(n).find("protocol").eq(0).text().toLowerCase() && (s = parseInt(re.$XML(t).eq(n).find("portNo").eq(0).text(), 10)),
            ...
            _ = function(e) {
                ...
                return e.oProtocolInc.getUPnPPortStatus(e, {
                    async: !1,
                    success: function(e) {
                        for (var t = re.$XML(e).find("portStatus", !0), n = 0, r = t.length; n < r; n++)"rtsp" == re.$XML(t).eq(n).find("internalPort").eq(0).text().toLowerCase() && (s = parseInt(re.$XML(t).eq(n).find("externalPort").eq(0).text(), 10)),
                ...
                return t.oProtocolInc.getNetworkBond(t, {
                    ...
                    success: function(e) {
                        "true" == re.$XML(e).find("enabled").eq(0).text() ? r.push({
                            ...
                            success: function(e) {
                                for (var t = 0,
                                n = re.$XML(e).find("NetworkInterface", !0).length; t < n; t++) {
                                    r.push({
                                        ipv4: re.$XML(e).find("ipAddress").eq(0).text(),
                                        ipv6: re.$XML(e).find("ipv6Address").eq(0).text()
                                    });
            ...
            B = function(e) {
                ...
                n = location.port || "80";
                return p.proxyAddress && (t = p.proxyAddress.ip, n = p.proxyAddress.port),
            ...
            this.I_InitPlugin = function(e, t, n) {
                if (h = e, f = t, v.extend(p, n), Z()) {
                    ...
                    // }) : v.loadScript(r + "/jsPlugin-1.2.0.min.js",
                    // function() {
                    //     n.cbInitPluginComplete && n.cbInitPluginComplete()
                    // }))),
                    //改写写法，兼容vue
                     require(["./jsPlugin-1.2.0.min.js"],function(e){
                        window.JSPlugin = e.JSPlugin
                        n.cbInitPluginComplete && n.cbInitPluginComplete()
                         }),

                    M(document.fullScreen) ? M(document.webkitIsFullScreen) ? M(document.mozFullScreen) || document.addEventListener("mozfullscreenchange",
                    function(e) {
            ...
            this.I_InsertOBJECTPlugin = function(e) {
                if (M(e) || (p.szContainerID = e), null == document.getElementById(p.szContainerID)) return - 1;
                
                if (null != document.getElementById(u) || 0 != document.getElementsByName(u).length) return - 1;
                ...
                if (Z()) {
                    ...
                    if ("" != n) {
                        for (var r = {},
                        s = n.split(";"), o = "", i = 0, a = s.length; i < a; i++) - 1 < (o = s[i]).indexOf("sub-background") ? r.background = "#" + o.split(":")[1] : -1 < o.indexOf("sub-border-select") ? r.borderSelect = "#" + o.split(":")[1] : -1 < o.indexOf("sub-border") && (r.border = "#" + o.split(":")[1]);
                        t.oStyle = r
                    }
                   
                    y = new JSPlugin(t)
                } else document.getElementById(p.szContainerID).innerHTML = q(),
            ...
            this.I2_OpenFileDlg = function(t) {
                ...
                return Z() ? y.JS_OpenFileBrowser(t, "").then(function(e) {
                    ...
                    n.resolve(e)
                }) : (null != (e = y.HWP_OpenFileBrowser(t, "")) ? 1 == t ? 100 < e.length && n.resolve( - 1) : 130 < e.length && n.resolve( - 1) : n.resolve(), n.resolve(e)),
                n
            },
            ...
            function j(e) {
                if (e && /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/.test(e)) {
                    if (4 === e.length) {
                        for (var t = "#",
                        n = 1; n < 4; n += 1) t += e.slice(n, n + 1).concat(e.slice(n, n + 1));
                        e = t
                    }
                    var r = [];
                    for (n = 1; n < 7; n += 2) r.push(parseInt("0x" + e.slice(n, n + 2)));
                    return "[" + r.join(",") + ",0.6]"
                }
                return e
            }
            ...
            this.getAuthType = function(t, n, e, r, s) {
                var o = {
                    async: !1,
                    success: function(e) {
                ...
                S.getSessionCap(n, e, r, s, o)
            },
            this.setDeviceInfo = function(e, t, n, r, s) {
                return (t = new O).szIP = n,
                2 == r ? (t.szHttpProtocol = "https://", t.iHttpsPort = s) : (t.szHttpProtocol = "http://", t.iHttpPort = s),
                t.iCGIPort = s,
            ...
            this.successV1cb = function(e, t, n, r, s, o, i, a) { (t = this.setDeviceInfo(e, t, n, r, s)).szAuth = re.$XML(o).find("sessionID").eq(0).text(),
                w(t),
                T("使用%s协议登录成功", x),
                G(t),
                ...
                u.sesstionTimer = setInterval(function() {
                    ...
                    function() {
                        u.sessionFailed++,
                        5 <= u.sessionFailed && (window.PluginEventHandler(null, -1, u.szDeviceIdentify), clearInterval(u.sesstionTimer))
                    })
                },
                3e4)
            },
            this.successV2cb = function(e, t, n, r, s, o, i, a) { (t = this.setDeviceInfo(e, t, n, r, s)).szAuth = L(0, t.szDeviceIdentify),
                w(t),
                T("使用%s协议登录成功", x),
                G(t),
                l(t.szDeviceIdentify, i, a),
            ...
            this.MD5=function(a) {  //新加的方法
                ...
                f = function(a) {
                    var b, c = a.length;
                    b = c + 8;
                    for (var d = ((b - b % 64) / 64 + 1) * 16, e = Array(d - 1), f = 0, g = 0; g < c;) b = (g - g % 4) / 4,
                    f = g % 4 * 8,
            ...
            this.I_Login = function(r, s, o, i, a, u) {
                var e = r + "_" + o;
                if ( - 1 != this.findDeviceIndexByIP(e)) return T("设备已经登录过"),
                -1;
                var c = S,
                l = x;
                if (M(u.cgi) || (l = x == u.cgi ? (c = S, x) : (c = C, 2)), Z()) if (x == l) {
                    var t = new O;
                    if (this.getAuthType(t, r, s, o, i), t.oAuthType[r] < 2) {
                        var n = this.I_LoginV1(c, t, r, s, o, i, a, u);
                        c.getSessionCap(r, s, o, i, n)
                    } else {
                        var d = MD5((new Date).getTime().toString()).substring(0, 8);
                        d = parseInt(d.replace("#", ""), 16).toString().substring(0, 8);
                        n = this.I_LoginV2(d, c, t, r, s, o, i, a, u);
                        c.getSessionV2Cap(d, r, s, o, i, n)
                    }
            ...
            this.I_StartRealPlay = function(e, t) {
                ...
                if (v.extend(c, t), -1 != n) {
                    ...
                    var l = I[n];
                    if (Z()) {
                        if (!l.bSupportWebsocket) return void(t.error && t.error(403, N()));
            ...
            this.I_Stop = function(e) {
                ...
                if ( - 1 != n) {
                    var r = m[n];
                    if (r.bRecord && (Z() || y.HWP_StopSave(r.iIndex)), r.bSound && (Z() || y.HWP_CloseSound()), r.bEZoom && (Z() || y.HWP_DisableZoom(r.iIndex)), Z()){
            ...
            this.I_SetVolume = function(e, t) {
                ...
                isNaN(e) || e < 0 || 100 < e || (t = M(t) ? P: t, -1 != this.findWndIndexByIndex(t) && (n = Z() ? (y.JS_SetVolume(t, e), 0) : y.HWP_SetVolume(t, e))),
                n
            },
            ...
            this.I_StopVoiceTalk = function() {
                ...
                if (!Z()) {
                    ...
                    for (var t = 0,
                    n = I.length; t < n; t++) if (I[t].bVoiceTalk) {
                        I[t].bVoiceTalk = !1;
                        break
                    }
                }
            ...
            this.I_Enable3DZoom = function(e) {
                ...
                if ( - 1 != t) {
                    var r = m[t];
                    r.b3DZoom || (Z() ? (n = 0, y.JS_Enable3DZoom(e,
                    function(e) {
            ...
            this.I_FullScreen = function(e) {
                Z() ? y.JS_FullScreenDisplay(e) : y.HWP_FullScreenDisplay(e)
            },
            ...
            this.I_ReversePlayback = function(e, t) {
                ...
                if (v.extend(l, t), -1 != n) {
                    ...
                    var d = I[n];
                    if (Z()) return r;
                    if ( - 1 == (i = 0 == parseInt(re.$XML(g).find("ProtocolType").eq(0).text(), 10) && d.oStreamCapa.bSupportShttpPlay ? (s = d.oProtocolInc.CGI.startShttpReversePlayback, o = "http://", u = l.iStreamType - 1, a = 100 * (a = l.iChannelID <= d.iAnalogChannelNum ? l.iChannelID: d.oStreamCapa.iIpChanBase + parseInt(l.iChannelID, 10) - d.iAnalogChannelNum - 1) + u, M(l.iPort) ? "https://" == d.szHttpProtocol ? ( - 1 == d.iHttpPort && (d.iHttpPort = W(d).iHttpPort), d.iHttpPort) : d.iCGIPort: (d.iHttpPort = l.iPort, l.iPort)) : (s = d.oProtocolInc.CGI.startPlayback, o = "rtsp://", u = l.iStreamType, a = 100 * l.iChannelID + u, M(l.iRtspPort) || (d.iRtspPort = l.iRtspPort), -1 == d.iRtspPort && (d.iRtspPort = W(d).iRtspPort), d.iRtspPort))) return T("获取端口号失败"),
                    r;
                    v.extend(l, {
                        urlProtocol: o,
                        cgi: s,
            ...
            this.I_PlaySlow = function(e) {
                ...
                a(e) ? v.extend(t, e) : M(e) || (t.iWndIndex = e);
                var n = this.findWndIndexByIndex(t.iWndIndex); - 1 != n ? 2 == m[n].iPlayStatus ? Z() ? y.JS_GetWndStatus(t.iWndIndex).iRate <= -4 ? t.error && t.error() : y.JS_Slow(t.iWndIndex).then(function() {
                    t.success && t.success()
                },
                function() {
                    t.error && t.error()
            ...
            this.I_PlayFast = function(e) {
                ...
                a(e) ? v.extend(t, e) : M(e) || (t.iWndIndex = e);
                var n = this.findWndIndexByIndex(t.iWndIndex); - 1 != n ? 2 == m[n].iPlayStatus ? Z() ? 8 <= y.JS_GetWndStatus(t.iWndIndex).iRate ? t.error && t.error() : y.JS_Fast(t.iWndIndex).then(function() {
                    t.success && t.success()
                },
                function() {
                    t.error && t.error()
            ...
            this.I_CheckPluginInstall = function() {
                ...
                if (Z()) e = 0;
                    ...
                    e = 0
                } catch(e) {} else for (var n = 0,
                r = navigator.mimeTypes.length; n < r; n++) if ("application/webvideo-plugin-kit" == navigator.mimeTypes[n].type.toLowerCase()) {
                    e = 0;
                    break
                }
                return e
            ...
            this.I_RemoteConfig = function(e, t) {
                ...
                if ( - 1 == s.iDevicePort) if ( - 1 == o.iDevicePort) {
                    if (o.iDevicePort = W(o).iDevicePort, -1 == (r = o.iDevicePort)) return - 1
                } else r = o.iDevicePort;
                else r = s.iDevicePort;
                if (":" == v.Base64.decode(o.szAuth)[0]) var i = v.Base64.decode(o.szAuth).split(":")[1],
                a = v.Base64.decode(o.szAuth).split(":")[2];
                else i = v.Base64.decode(o.szAuth).split(":")[0],
            ...
            this.I2_SetSnapPolygonInfo = function(e, t) {
                if (Z()) {
                    ...
                    for (nodeList = re.$XML(n).find("SnapPolygon", !0), i = 0, iLen = nodeList.length; i < iLen; i++) {
                        ...
                        s = "#" + (s = V(s, 6));
                        for (var o = [], a = re.$XML(node).find("point", !0), u = 0, c = a.length; u < c; u++) oNodePoint = a[u],
            ...
            this.I_SetSnapPolygonInfo = function(e, t) {
                if (Z()) {
                    ...
                    function(e, t) {
                        i.push(t.id)
                    }), S = "," + (S = i.join(",")) + ",", 32 < n.length + s.length) return - 3;
                    for (var a = 0,
                    u = s.length; a < u; a++) {
                        var c = (h = s[a]).id;
                ...
                i = [];
                for (a = 0, u = p.length; a < u; a++) h = p[a],
                i.push(re.$XML(h).find("id").eq(0).text());
                if (S = "," + (S = i.join(",")) + ",", r = v.loadXML(t), 32 < C + (p = re.$XML(r).find("SnapPolygon", !0)).length) return - 3;
                for (a = 0, u = p.length; a < u; a++) {
                    if (h = p[a], c = re.$XML(h).find("id").eq(0).text(), !v.isInt(c)) return - 2;
                    if ((f = parseInt(c, 10)) < 1 || 32 < f) return - 2;
                    if ( - 1 < S.indexOf("," + c + ",")) return - 4;
                    if (32 < re.$XML(h).find("tips").eq(0).text().length) return - 2;
                    if (! ("true" === re.$XML(h).find("isClosed").eq(0).text())) {
                        if (l = re.$XML(h).find("MinClosed").eq(0).text(), !v.isInt(l)) return - 2;
                        if ((P = parseInt(l, 10)) < 4 || 17 < P) return - 2;
                        if (d = re.$XML(h).find("PointNumMax").eq(0).text(), !v.isInt(d)) return - 2;
                        if ((I = parseInt(d, 10)) < P || 17 < I) return - 2
                    }
                }
                return y.HWP_SetSnapPolygonInfo(e, t)
            ...
            this.I_GetSnapPolygonInfo = function(e) {
                if (Z()) {
                    for (var t = y.JS_GetPolygonInfo(e), n = '<?xml version="1.0" encoding="utf-8"?><SnapPolygonList>', r = 0; r < t.length; r++) {
                        ...
                        for (var o = 0; o < t[r].aPoint.length; o++) n += "<point><x>" + t[r].aPoint[o][0] / h + "</x><y>" + t[r].aPoint[o][1] / f + "</y></point>";
            ...
            this.I_DeviceCapturePic = function(e, t, n, r) {
                ...
                if ( - 1 != s) {
                    ...
                    if (v.extend(a, r), !M(a.iResolutionWidth) && !v.isInt(a.iResolutionWidth)) return o;
                    if (!M(a.iResolutionHeight) && !v.isInt(a.iResolutionHeight)) return o;
            ...
            this.findDeviceIndexByIP = function(e) {
                // I指已经登录的硬盘录像机，如果有已经登陆的
                if ( - 1 < e.indexOf("_")) {
                    for (var t = 0,
                    n = I.length; t < n; t++) if (I[t].szDeviceIdentify == e) return t
                } else for (t = 0, n = I.length; t < n; t++) if (I[t].szIP == e) return t;
                return - 1
            },
            this.findWndIndexByIndex = function(e) {
                for (var t = 0,
                n = m.length; t < n; t++) if (m[t].iIndex == e) return t;
                return - 1
            };
            var J = function() {
                this.iIndex = 0,
            ...
            K.prototype.submitRequest = function() {
                ...
                if (Z()) {
                    ...
                    if (this.options.async) {
                        var u = y.HWP_SubmitHttpRequest(a, this.options.url, this.options.auth, this.options.data, this.options.timeout); - 1 != u && (t = {
                            iRequestID: u,
            ...
            e.prototype.getAudioInfo = function(e, n) {
                var t = b(this.CGI.getAudioInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getSecurityVersion = function(e, n) {
                var t = b(this.CGI.getSecurityVersion, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getDeviceInfo = function(e, n) {
                var t = b(this.CGI.getDeviceInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getAnalogChannelInfo = function(e, i) {
                var t = b(this.CGI.getAnalogChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
                n = new K,
                r = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getDigitalChannelInfo = function(e, a) {
                ...
                if (this.getDigitalChannel(e, {
                    ...
                    var t = b(this.CGI.getDigitalChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
                    n = new K,
                    r = {
                        type: "GET",
                        url: t,
            ...
            e.prototype.getZeroChannelInfo = function(e, n) {
                var t = b(this.CGI.getZeroChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getPPPoEStatus = function(e, n) {
                var t = b(this.CGI.getPPPoEStatus, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getUPnPPortStatus = function(e, n) {
                var t = b(this.CGI.getUPnPPortStatus, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getNetworkBond = function(e, n) {
                var t = b(this.CGI.getNetworkBond, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getNetworkInterface = function(e, n) {
                var t = b(this.CGI.getNetworkInterface, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.getPortInfo = function(e, n) {
                var t = b(this.CGI.getPortInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.startRealPlay = function(t, n) {
                ...
                if ("rtsp://" === n.urlProtocol && (s = A(s)), r = n.bZeroChannel ? (Z() && (e = 0), b(n.cgi.zeroChannels, n.urlProtocol, s, n.iPort, e)) : b(n.cgi.channels, n.urlProtocol, s, n.iPort, e), p.proxyAddress && Z()) {
                    ...
                    var o = s + ":" + n.iPort; - 1 < r.indexOf("?") ? r += "&deviceIdentify=" + o: r += "?deviceIdentify=" + o
                }
                var i = function() {
                    var e = new J;
            ...
            e.prototype.startVoiceTalk = function(e, t) {
                var n = b(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
                r = b(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
                s = b(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t);
                ...
                v.extend(c, {
                    ...
                    error: function(e, t) {
                        if (d == s.szDeviceType || z == s.szDeviceType) {
                            a = o.bShttpIPChannel ? b(l.CGI.ptzControl.analog, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID - s.oStreamCapa.iIpChanBase + 1 + s.iAnalogChannelNum) : b(l.CGI.ptzControl.analog, s.szHttpProtocol, s.szIP, s.iCGIPort, o.iChannelID),
            ...
            e.prototype.recordSearch = function(e, i) {
                var t, n, r = i.iChannelID,
                s = i.iStreamType,
                o = i.szStartTime.replace(" ", "T") + "Z",
                a = i.szEndTime.replace(" ", "T") + "Z";
                t = b(this.CGI.recordSearch, e.szHttpProtocol, e.szIP, e.iCGIPort),
            ...
            e.prototype.startPlayback = function(t, n) {
                ...
                if ("rtsp://" === n.urlProtocol && (i = A(i)), Z()) if (p.proxyAddress) {
                    ...
                    var a = i + ":" + n.iPort; - 1 < e.indexOf("?") ? e += "&deviceIdentify=" + a: e += "?deviceIdentify=" + a
                ...
                if (!M(n.oTransCodeParam)) {
                    var u = function(e) {
                        ...
                        if (v.extend(t, e), "" == t.TransFrameRate || "" == t.TransResolution || "" == t.TransBitrate) return "";
                        var n = [];
            ...
            e.prototype.reversePlayback = function(e, t) {
                ...
                var i = b(t.cgi, t.urlProtocol, o, t.iPort, t.iChannelID, r, s),
            ...
            e.prototype.startDownloadRecord = function(e, t) {
                var n = b(this.CGI.startDownloadRecord, e.szHttpProtocol, e.szIP, e.iCGIPort),
            ...
            e.prototype.restart = function(e, n) {
                var t = b(this.CGI.restart, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "PUT",
                    url: t,
            ...
            e.prototype.restore = function(e, t, n) {
                var r = b(this.CGI.restore, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
                s = new K,
                o = {
                    type: "PUT",
                    url: r,
            ...
            e.prototype.startUpgrade = function(e, t) {
                $.Deferred();
                var n = b(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = b(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
                return szRet = y.HWP_StartUpgrade(n, r, e.szAuth, t.szFileName)
            },
            e.prototype.asyncstartUpgrade = function(e, t) {
                var n = $.Deferred(),
                r = b(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort),
                s = b(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
                if (Z()) r = B(r),
                s = B(s),
            ...
            e.prototype.getSDKCapa = function(e, n) {
                var t = b(this.CGI.SDKCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            e.prototype.deviceCapturePic = function(e, t, n, r) {
                t = 100 * t + 1;
                var s, o, i = -1,
                a = b(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
                u = [];
            ...
            e.prototype.getSessionCap = function(e, t, n, r, s) {
                var o = "";
                o = 2 == t ? "https://": "http://";
                var i = b(this.CGI.sessionCap, o, e, n, encodeURIComponent(r)),
                a = new K,
                u = {
                    type: "GET",
                    url: i,
            ...
            e.prototype.sessionV2Login = function(e, t, n, r, s, o, i, a) {
                ...
                d = b(this.CGI.sessionLogin, u, t, r),
                p = re.$XML(i).find("sessionID").eq(0).text(),
                h = re.$XML(i).find("challenge").eq(0).text(),
                f = parseInt(re.$XML(i).find("iterations").eq(0).text(), 10),
                P = !1,
                I = "";
                0 < re.$XML(i).find("isIrreversible", !0).length && (P = "true" === re.$XML(i).find("isIrreversible").eq(0).text(), I = re.$XML(i).find("salt").eq(0).text()),
            ...
            e.prototype.sessionLogin = function(e, t, n, r, s, o, i) {
                var a = "";
                a = 2 == t ? "https://": "http://";
                var u = b(this.CGI.sessionLogin, a, e, n),
            ...
            e.prototype.sessionHeartbeat = function(e, n) {
                var t = b(this.CGI.sessionHeartbeat, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "PUT",
                    url: t,
            ...
            e.prototype.sessionLogout = function(e, n) {
                var t = b(this.CGI.sessionLogout, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "PUT",
                    url: t,
            ...
            e.prototype.getSystemCapa = function(e, n) {
                var t = b(this.CGI.systemCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            n.prototype.getPortInfo = function(o, i) {
                var e = b(this.CGI.getPortInfo, o.szHttpProtocol, o.szIP, o.iCGIPort),
                t = new K,
                n = {
                    type: "GET",
                    url: e,
            ...
            n.prototype.getStreamDynChannels = function(e, n) {
                var t = b(this.CGI.getStreamDynChannels, e.szHttpProtocol, e.szIP, e.iCGIPort),
                r = new K,
                s = {
                    type: "GET",
                    url: t,
            ...
            n.prototype.startRealPlay = function(e, t) {
                ...
                r = t.bZeroChannel ? b(t.cgi.zeroChannels, t.urlProtocol, s, t.iPort, n) : b(t.cgi.channels, t.urlProtocol, s, t.iPort, n);
            ...
            n.prototype.ptzAutoControl = function(s, e, o, i) {
                ...
                a = "",
                u = "";
                if (i.iPTZSpeed = i.iPTZSpeed < 7 ? 15 * i.iPTZSpeed: 100, e && (i.iPTZSpeed = 0), s.szDeviceType != D) a = b(this.CGI.ptzAutoControl, s.szHttpProtocol, s.szIP, s.iCGIPort, t),
                u = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + i.iPTZSpeed + "</pan><tilt>0</tilt></PTZData>";
                else {
                    var n = 99;
                    e && (n = 96),
                    a = b(this.CGI.goPreset, s.szHttpProtocol, s.szIP, s.iCGIPort, t, n)
                }
                var r = new K,
                c = {
                    type: "PUT",
            ...
            n.prototype.setPreset = function(e, t, n) {
                t.iChannelID;
                var r, s = "";
                r = b(this.CGI.setPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID),
                s = "<?xml version='1.0' encoding='UTF-8'?>",
                s += "<PTZPreset>",
                s += "<id>" + n.iPresetID + "</id>",
                e.szDeviceType != D && (s += "<presetName>Preset" + n.iPresetID + "</presetName>"),
            ...
            n.prototype.set3DZoom = function(e, t, n, r) {
                var s = b(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID),
                o = new K,
                i = {
                    type: "PUT",
                    url: s,
            ...
            n.prototype.deviceCapturePic = function(e, t, n, r) {
                t = 100 * t + 1;
                var s = b(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
                o = [];
            ...
            ee.prototype.extend = function() {
                ...
                n = 1, r = arguments.length; n < r; n++) if (null != (e = arguments[n])) for (var s in e) {
                    t[s];
                    var o = e[s];
            ...
            ee.prototype.Base64 = {
                ...
                encode: function(e) {
                    var t, n, r, s, o, i, a, u = "",
                    c = 0;
                    for (e = ee.prototype.Base64._utf8_encode(e); c < e.length;) s = (t = e.charCodeAt(c++)) >> 2,
                ...
                decode: function(e) {
                    var t, n, r, s, o, i, a = "",
                    u = 0;
                    for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); u < e.length;) t = this._keyStr.indexOf(e.charAt(u++)) << 2 | (s = this._keyStr.indexOf(e.charAt(u++))) >> 4,
                ...
                _utf8_decode: function(e) {
                    for (var t = "",
                    n = 0,
                    r = c1 = c2 = 0; n < e.length;)(r = e.charCodeAt(n)) < 128 ? (t += String.fromCharCode(r), n++) : 191 < r && r < 224 ? (c2 = e.charCodeAt(n + 1), t += String.fromCharCode((31 & r) << 6 | 63 & c2), n += 2) : (c2 = e.charCodeAt(n + 1), c3 = e.charCodeAt(n + 2), t += String.fromCharCode((15 & r) << 12 | (63 & c2) << 6 | 63 & c3), n += 3);
                    return t
                }
            },
            ...
            ee.prototype.getDirName = function() {
                ...
                if ("" !== p.szBasePath) e = p.szBasePath;
                    ...
                    if (n) e = n.src.match(t)[0];
                        ...
                        s = 0,
                        o = r.length; s < o; s++) if ( - 1 < r[s].src.indexOf("webVideoCtrl.js")) {
                            n = r[s];
                            break
                        }
                        n && (e = n.src.match(t)[0])
            ...
            ee.prototype.strToAESKey = function(e, t) {
                ...
                if (0 < oSecurityCap.iKeyIterateNum) {
                    ...
                    for (var r = 1; r < oSecurityCap.iKeyIterateNum; r++) n = v.sha256(n)
                }
            ...
            ee.prototype.encodeAES = function(e, t, n, r) {
                ...
                i = 0; 0 < o;) s += 16 < o ? aes_encrypt(e.substring(i, i + 16), t, !0) : aes_encrypt(e.substring(i), t, !0),
                o -= 16,
                i += 16;
                else {
            ...
            ee.prototype.sha256 = function(e) {
                ...
                return function(e) {
                    ...
                    for (e[t >> 5] |= 128 << 24 - t % 32, e[15 + (t + 64 >> 9 << 4)] = t, l = 0; l < e.length; l += 16) {
                        for (n = P[0], r = P[1], s = P[2], o = P[3], i = P[4], a = P[5], u = P[6], c = P[7], d = 0; d < 64; d++) I[d] = d < 16 ? e[d + l] : m(m(m(S(I[d - 2], 17) ^ S(I[d - 2], 19) ^ I[d - 2] >>> 10, I[d - 7]), S(I[d - 15], 7) ^ S(I[d - 15], 18) ^ I[d - 15] >>> 3), I[d - 16]),
            ...
            te.getIntegerBits = function(e, t, n) {
                ...
                for (i = Math.floor(t / 4); i <= Math.floor(n / 4); i++) s[i] && "" != s[i] ? o += s[i] : o += "0";
                return o
            },
